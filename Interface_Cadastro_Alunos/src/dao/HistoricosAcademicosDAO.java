...
public class HistoricosAcademicosDAO {
    ...
    public void adicionar(HistoricosAcademicos historicosAcademicos) {
        String sql = "INSERT INTO b'cadastro_alunos' (id_aluno, id_curso, data, status) VALUES (?, ?, ?, ?, ?)";
        try {
            PreparedStatement stmt = conexao.prepareStatement(sql);
            stmt.setString(1, historicosAcademicos.getId_aluno());
            stmt.setString(2, historicosAcademicos.getId_curso());
            stmt.setString(3, historicosAcademicos.getData());
            stmt.setString(4, historicosAcademicos.getStatus());
            stmt.execute();
            stmt.close();
    ...
    public void alterar(HistoricosAcademicos historicosAcademicos) {
        String sql = "UPDATE b'cadastro_alunos' SET id_aluno = ?, id_curso = ?, data = ?, status = ? WHERE id = ?";
        try {
            PreparedStatement stmt = conexao.prepareStatement(sql);
            stmt.setString(1, historicosAcademicos.getId_aluno());
            stmt.setString(2, historicosAcademicos.getId_curso());
