 ...
 * @author Guilherme
 */
public class Tela_cadastrar_aluno extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Tela_cadastrar_aluno.class.getName());

    /**
     * Creates new form Tela_cadastrar_aluno
     */
    public Tela_cadastrar_aluno() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Tela_cadastrar_aluno().setVisible(true));
    }
